    ...
    <div class="carousel-inner">
        <div class="item active">
            <div class="alert alert-primary " style="background-color: rgba(168,171,174,0.99); margin-bottom: 0px; margin-top: 0px; margin-right: auto; margin-left: auto; padding-top: 15px;  padding-left: 60px; ">
                ...
                <header>
                    <h2>
                <span><b><u>Киннориум. <br>Новости кино. Все о новинках киноиндустрии.</u></b>
                </span>
                    </h2>
                </header>
            </div>
        ...
        <div class="item ">
            <img src="/images/star_trek_discovery_season_2_title_card.1.png" alt="...">
        </div>
        <div class="item">
            <img src="/images/wallpapers-movies-018.jpg" alt="...">
        </div>
        <div class="item">
            <img src="/images/filmz.ru_f_126532.jpg" alt="...">
        </div>

    </div>
</div>
<script>
    $('.carousel').carousel({data-interval: 2000});
</script>
...
<!--        <header>-->
<!--            <h2>-->
<!--                <span><b><u>Киннориум. <br>Новости кино. Все о новинках киноиндустрии. <?//= !(Yii::$app->user->isGuest) ? Yii::$app->user->identity->username :"" ?></u></b>-->
<!--                </span>-->
<!--            </h2>-->
<!--        </header>-->
<!--    </div>-->
...
<?php foreach($articles as $article) : ?>
    ...
    <div class="jumbotron " style="background-color: rgba(168,171,174,0.99); margin-right: auto;  margin-left: auto; padding-top: 15px; padding-bottom: 5px; margin-top:0px; margin-bottom: 12px; ">
